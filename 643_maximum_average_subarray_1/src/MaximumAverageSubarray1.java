...
public class MaximumAverageSubarray1 {
    public static void main(String[] args) {
        ...
        int k = 4;
        System.out.println("Solution 1 result is: " + solution1.findMaxAverage(nums, k) + "(should be 12.75)");
        System.out.println("Solution 2 result is: " + solution2.findMaxAverage(nums, k) + "(should be 12.75)");

        nums = new int[]{-1};
        k = 1;
        System.out.println("Solution 1 result is: " + solution1.findMaxAverage(nums, k) + "(should be -1.0)");
        System.out.println("Solution 2 result is: " + solution2.findMaxAverage(nums, k) + "(should be -1.0)");
    }
