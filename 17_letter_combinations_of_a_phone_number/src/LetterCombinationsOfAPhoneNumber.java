void main() {
    ...
    IO.println("For digits 23 expected is [ad, ae, af, bd, be, bf, cd, ce, cf]");
    IO.println("Calculated is " + solver.letterCombinations("23"));
    IO.println("Calculated is " + solver.letterCombinationsBacktracking("23"));
}
